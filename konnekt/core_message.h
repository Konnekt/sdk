	...
	public:
		...
		*/
		enum enFlags {
			...
			flagMenuByUI     = 0x400, /**< Interfejs obs³u¿y wyœwietlanie wiadomoœci w menu.
...
//            #define C_MSG_COLCOUNT     14 // ostatni
    ...
    */
    class MessageSelect {
	private: unsigned short _s_size;
	public : int net; ///< Sieæ kontaktu. Ustaw na #NET_BC aby u¿yæ wszystkich sieci.
	private: char * _chUid;  ///< UID kontaktu. Ustaw 0 aby u¿yæ wszystkich.
	public:
		Stamina::String getUid() const {

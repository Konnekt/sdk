 ...
 * Zawarte tu informacje mog¹ ulec zmianie! Spora czêœæ dokumentacji jest nieukoñczona,
 * a wiele pozycji jest s³abo udokumentowanych! Mo¿e siê zdarzyæ, ¿e niektóre sekcje
 * nie s¹ ju¿ aktualne!!!
 *
 ...
 * 
 * @section whats_up Co? gdzie? jak?
 * - Zacznij przegl¹danie dokumentacji od strony @ref develop. Przeczytaj j¹ uwa¿nie i w @b ca³oœci!
 ...
 * @ref changelog
 * 
 * @section info Czym jest Konnekt ?
 * @b Konnekt jest programem - @e serwerem o otwartej architekturze.
 * Pozwala na do³¹czanie do @e rdzenia (g³ówna aplikacja *.exe)
 ...
 * Microsoft Visual C++ 2005 (v8.0). Na wersji 7.x jak i w kompilatorach Borlanda
 * nie powinny wyst¹piæ ¿adne problemy...
 * 
 * Przed przyst¹pieniem do pracy z kodem zapoznaj siê z @ref license "licencj¹"!
 * 
 * Informacje o autorze znajdziesz @ref team "tutaj".
 * 
 * Na pocz¹tek polecam tekst @ref develop.
 * 
 * @subsection links Odsy³acze:
 ...
 *
 * SDK s³u¿y do przygotowywania oprogramowania wspó³pracuj¹cego z programem %Konnekt.\n
 * Grupa Stamina nie ponosi odpowiedzialnoœci za wykorzystanie tego kodu.
 */
 ...
 * 
 * &copy; 2002-2008 Rafa³ "HAO" Lindemann, <a href="http://www.stamina.pl/"><b>Stamina</b></a>\n
 ...
 * 
 * @warning Na jedn¹ z przysz³ych wersji Konnekta jest ju¿ przygotowana zmiana obs³ugi statusów
 * na bardziej automatyczn¹, dlatego pomijam tutaj sprawê statusów opisowych...
 * 
 * @section into Na pocz¹tek
 ...
 * 
 * @section basics Obs³uga podstawowych komunikatów
 * - #IM_PLUG_TYPE - zwracaj¹c po³¹czenie co najmniej: #IMT_MESSAGE | #IMT_PROTOCOL | #IMT_CONTACT | #IMT_NET | #IMT_MESSAGEACK | #IMT_NETUID
 *   Je¿eli wtyczka ma obs³ugiwaæ wyszukiwanie kontaktów trzeba te¿ dodaæ: #IMT_NETSEARCH
 * - #IM_PLUG_NETNAME - zwracaj¹c nazwê sieci
 * - #IM_PLUG_PRIORITY - wszystkie istniej¹ce wtyczki sieciowe zwracaj¹ #priorityLow, nie nale¿y siê wiêc wy³amywaæ...
 ...
 * - #IM_ISCONNECTED
 *
 * @section msg_rcv Odbieranie wiadomoœci
 * Gdy odbieramy wiadomoœæ z sieci, trzeba wstawiæ j¹ do kolejki, ¿eby u¿ytkownik
 * i pozosta³e wtyczki mog³y j¹ przeczytaæ.
 * Tworzymy wiêc i wype³niamy obiekt typu Message.\n W Message::flag najlepiej
 * ustawiæ #Message::flagHandledByUI. W ten sposób otwieraniem wiadomoœci, ustawieniem ikonki
 ...
 * @endcode
 *
 * @section msg_send Wysy³anie wiadomoœci
 ...
 * Do tworzenia w¹tków najlepiej u¿yæ cCtrl::BeginThread(), lub cCtrl::BeginThreadAndWait()
 * @code
 * case IM_MSG_SEND: {
 *   cMessage * m = (cMessage*) msg->p1;
 ...
 * @endcode
 *
 * @section cntlist Lista kontaktów
 ...
 *
 * @section ignlist Lista ignorowanych
 ...
 * siê stan (online, offline itd.), oraz flagi.\n ¯eby odczytaæ stan, trzeba na³o¿yæ
 ...
 * @code
 * // W zasobach wtyczki mamy 5 ikonek:
 * // - 100 - status online
 * // - 101 - status offline
 ...
 * w toku.\n S³u¿¹ do tego komunikaty #IMI_LONGSTART, #IMI_LONGSET i #IMI_LONGEND
 * razem ze struktur¹ sDIALOG_long...
 *
 * @section outro Na koniec.
 * To z grubsza wszystko, co potrzebne jest do obs³ugi sieci w Konnekcie. Powodzenia! :)
 */
 ...
 * - podczas obs³ugi komunikatów, gdy ju¿ zrobimy co chcemy, przesy³amy komunikat dalej, do poprzedniego w³aœciciela akcji, aby wykona³ swoje zadania...
 *
 ...
 *
 * // Zapisujemy poprzedniego w³aœciciela w globalnej zmiennej (typu int)
 * cnt_info_prev_owner = ICMessage(IMI_ACTION_GETOWNER, (int) &nfo.act);
 * // Jak dostaniemy b³êdny wynik (np. gdy jest stare UI) uznajemy ¿e w³aœcicielem jest interfejs
 * if (!cnt_info_prev_owner) {
 *   cnt_info_prev_owner = ICMessage(IMC_PLUG_ID, 0);
 * }
 ...
 *     // Ty mo¿esz zrobiæ absolutnie co zechcesz, pamiêtaj tylko, ¿eby blokowaæ (nie przekazywaæ dalej) komunikaty ŒWIADOMIE!
 *     // Pamiêtaj, ¿e ktoœ inny, równie¿ mo¿e wykonaæ podobny trick zaraz po tobie...
 ...
 *     return IMessageDirect(IM_UIACTION, cnt_info_prev_owner, (int) anBase);
 *   }
 * }
 * @endcode
 */

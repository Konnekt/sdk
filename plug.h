...
Komunikat przesy≥any jest przy pomocy @b sIMessage_plugArgs .*/ 
		...
		*/
		#define IM_DEBUG_COMMAND  IM_BASE+25
		 ...
		 #define IM_PLUG_PLUGOUT IM_BASE + 23     ///< Za chwilÍ wtyczka o podanym ID zostanie od≥πczona.
        ...
        #define  IM_ISCONNECTED   IM_SHARE+3006  ///< Trzeba zwrÛciÊ 1 jeúli jesteúmy po≥πczeni.
         ...
         #define IM_CNT_REMOVE    IM_BASE+4002  ///< Kontakt zaraz zostanie usuniÍty.
         ...
         #define IM_CNT_ADDING    IM_BASE+4004  ///< Kontakt jest w trakcie tworzenia (ktÛre moøe zostaÊ ew. przerwane)
                                                 ...
                                                 ///  \param p1 (int) ID kontaktu
         #define IM_CNT_SEARCH    IM_BASE+4010  ///< Øπdanie szukania kontaktu (np. w katalogu sieci)
         ...
         #define IM_CNT_CHANGED   IM_BASE+4006  ///< Istotna cecha kontaktu (np. UID) zosta≥a zmieniona.
                                                 ...
                                                 ///  Jeøeli przecastujesz to na sIMessage_2params to \a p1 jest ID kontaktu.
...
@return (const char*) identyfikator sesji (MD5 úcieøki katalogu profilu)
		...
		*/
        ...
        #define IMC_CNT_ADD        230 ///< Dodaje kontakt.
                                        ///  Po ustawieniu parametrÛw kontaktu, lub od razu po #IMC_CNT_ADD
                                        ///  trzeba wys≥aÊ #IMC_CNT_CHANGED
                                        ///  \param p1 (int) sieÊ
                                        ///  \param p2 (int) UID
        ...
        #define IMC_CNT_COUNT      201 ///< Zwraca iloúÊ kontaktÛw.
